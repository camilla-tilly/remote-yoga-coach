...
const post: BlogPost = {
  slug: "wellbeing-lunch-and-learn-ideas",
  title: "Virtual wellbeing lunch and learn ideas for remote teams",
  ...
  content: [
    ...
    {
      type: "heading",
      text: "What a wellbeing lunch and learn is really for",
    },
    {
      type: "paragraph",
    ...
    {
      type: "heading",
      text: "Why the usual talking-head webinar falls flat",
    },
    {
      type: "paragraph",
      text: "Three things tend to sink the standard corporate lunch and learn for a distributed team:",
    },
    {
      type: "list",
      items: [
    ...
    {
      type: "heading",
      text: "Virtual lunch and learn ideas that actually land",
    },
    {
      type: "subheading",
      text: "A guided breathing and gentle chair-yoga reset",
    },
    {
      type: "paragraph",
    ...
    {
      type: "subheading",
      text: "A short guided meditation or wind-down",
    },
    {
      type: "paragraph",
    ...
    {
      type: "subheading",
      text: "A practical breathing skills session",
    },
    {
      type: "paragraph",
    ...
    {
      type: "heading",
      text: "Start with one session, then decide",
    },
    {
      type: "paragraph",
