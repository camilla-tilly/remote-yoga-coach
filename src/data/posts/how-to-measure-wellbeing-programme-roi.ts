...
const post: BlogPost = {
  ...
  content: [
    ...
    { type: 'paragraph', text: 'A lot of wellbeing content leans on a big multiplier statistic, a return of so many pounds for every pound spent, borrowed from a report nobody in the room has read. It sounds persuasive until someone asks where the number came from, and it cannot be traced back to your team. At that point it weakens your case.' },
    { type: 'paragraph', text: 'A more durable approach is to track two internal proxies you fully control: participation and self-reported wellbeing. Neither one claims to be a financial return. You collect both yourself, so you can answer follow-up questions about them.' },
