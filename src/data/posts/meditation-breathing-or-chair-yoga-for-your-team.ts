...
const post: BlogPost = {
  ...
  content: [
    ...
    { type: 'callout', text: 'None of the three requires a mat, a change of clothes, or the camera on. All three run live on Teams or Zoom, with me coaching every week.' },
    { type: 'heading', text: 'How I help a team choose' },
    { type: 'paragraph', text: 'When someone books a demo, I usually ask two or three questions before recommending anything, because the right starting point depends on what is going on in the team, not on what sounds appealing on paper.' },
    ...
    { type: 'cta', text: 'Not sure which class type fits your team? Book a demo and I will run a short live session so you can see how it feels before deciding.', ctaHref: '/demo', ctaLabel: 'Book a demo session' },
    { type: 'faq', faqItems: [
      ...
      { q: 'Can we switch between class types later?', a: 'Yes. Because the format (live, seated, camera optional, recorded) is the same for all three, switching does not disrupt the routine. It just changes the focus of that week’s session.' },
      { q: 'Do we need any equipment for any of the three?', a: 'No. All three run seated over Teams or Zoom, with no mat or floor space needed. Chair yoga uses an ordinary desk chair for support, and meditation and breathing need nothing more than a quiet-ish spot to sit.' },
    ] },
  ],
};
