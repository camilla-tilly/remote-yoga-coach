...
const post: BlogPost = {
  ...
  content: [
    ...
    { type: 'callout', text: 'None of the three requires a mat, a change of clothes, or the camera on. All three run live on Teams, with me coaching every week.' },
    ...
    { type: 'faq', faqItems: [
      ...
      { q: 'Can we switch between class types later?', a: 'Yes. Because the format (live, seated, camera optional, recorded on request) is the same for all three, switching does not disrupt the routine. It just changes the focus of that week’s session.' },
