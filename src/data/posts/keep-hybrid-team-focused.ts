...
const post: BlogPost = {
  ...
  content: [
    ...
    { type: 'paragraph', text: 'More meetings will not fix this. What helps is a few deliberate rituals that reach everyone the same way, wherever they sit.' },
    ...
    { type: 'list', items: [
      '**Write decisions down.** Treat a decision made in the office as unfinished until it is written in a shared channel. This one rule closes most of the hybrid information gap.',
      ...
      '**Make one person accountable for context.** Someone owns keeping the remote half as informed as the in-office half. If nobody owns it, it does not happen.',
    ] },
    ...
    { type: 'paragraph', text: 'A hybrid team benefits from one fixed point in the week that is not a task, and that everyone attends in exactly the same way. When it happens live on screen, everyone joins the same way, so the difference between office and home disappears for the length of the session.' },
    { type: 'paragraph', text: 'A live wellbeing session works well as that anchor: a weekly slot on Teams, the same coach each week, sessions recorded on request for anyone who cannot join live. The classes work at a desk: meditation, breathing or chair yoga, with no mat and no changing.' },
    { type: 'paragraph', text: 'It is meant as a weekly habit rather than a one-off event, and it is the model behind my [wellbeing programme for remote and hybrid teams](/services/corporate-wellbeing-for-remote-teams). One recurring session on a flat monthly subscription does not get more complicated as people move between home and office.' },
    ...
    { type: 'faq', faqItems: [
      ...
      { q: 'What is a good shared anchor for a hybrid team?', a: 'A fixed weekly point that is not a task and that everyone attends identically. I run live wellbeing sessions on Teams for this: the same coach each week, recorded on request, with meditation, breathing and chair yoga classes that work at any desk.' },
