...
const post: BlogPost = {
  ...
  content: [
    ...
    { type: 'paragraph', text: 'A hybrid team benefits from one fixed point in the week that is not a task, and that everyone attends in exactly the same way. When it happens live on screen, the office and home divide disappears for that half hour. Everyone is a face in the same grid.' },
    { type: 'paragraph', text: 'A live wellbeing session works well as that anchor: a weekly slot on Teams or Zoom, the same coach each week, camera optional, and every session recorded for anyone who cannot join live. The content works at a desk: breathing, a little meditation, and chair yoga that needs no mat and no changing.' },
    { type: 'paragraph', text: 'It is a habit, not an event, and it is the model behind my [wellbeing programme for remote and hybrid teams](/services/corporate-wellbeing-for-remote-teams). One recurring session on a flat monthly subscription does not get more complicated as people move between home and office. After each session I report attendance and a short wellbeing check.' },
    ...
    { type: 'faq', faqItems: [
      ...
      { q: 'What is a good shared anchor for a hybrid team?', a: 'A fixed weekly point that is not a task and that everyone attends identically. I run live wellbeing sessions on Teams or Zoom for this: the same coach each week, camera optional, recorded, with breathing, meditation and chair yoga that works at any desk.' },
      { q: 'Does a shared wellbeing session get more complicated as people move between home and office?', a: 'No. It is one recurring session for the whole team on a flat monthly subscription, live on screen, so it reaches everyone the same way. After each session I report attendance and a short wellbeing check.' },
    ] },
  ],
};
