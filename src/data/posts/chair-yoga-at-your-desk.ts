...
const post: BlogPost = {
  ...
  content: [
    {
      type: 'paragraph',
      text: "If you spend your day at a desk, you already know where it ends up: a stiff neck, tight shoulders, a back that aches by four o'clock. You can undo a surprising amount of that tension without leaving your chair or changing your clothes.",
    },
    {
      type: 'paragraph',
      text: 'Here are eight chair yoga poses you can do at your desk in about five minutes, the length of a gap between two calls. Move gently, breathe slowly, and stop short of any sharp pain.',
    },
    { type: 'heading', text: 'Before you start' },
    {
      type: 'paragraph',
      text: 'Sit toward the front of your chair, both feet flat on the floor, and take three slow breaths: in through the nose for a count of four, out for a count of six. That longer exhale tells your nervous system to settle. Keep it going through the whole sequence.',
    },
    { type: 'subheading', text: '1. Seated neck release' },
    {
      type: 'paragraph',
      text: 'Drop your right ear toward your right shoulder. Let the weight of your head do the work, no pulling. Three slow breaths, then the other side.',
    },
    { type: 'subheading', text: '2. Shoulder rolls' },
    {
      type: 'paragraph',
      text: 'Roll both shoulders up toward your ears, back, and down, in slow circles. Five one way, five the other.',
    },
    { type: 'subheading', text: '3. Seated cat-cow' },
    {
      type: 'paragraph',
      text: 'Hands on knees. As you breathe in, lift your chest and look slightly up (cow). As you breathe out, round your back and drop your chin (cat). Move with your breath for five rounds.',
    },
    { type: 'subheading', text: '4. Seated twist' },
    {
      type: 'paragraph',
      text: 'Sit tall. Place your right hand on the outside of your left knee and gently turn to look over your left shoulder. Three breaths, then switch. Grow tall on each inhale rather than cranking yourself around.',
    },
    { type: 'subheading', text: '5. Wrist and finger stretch' },
    {
      type: 'paragraph',
      text: 'Extend one arm, palm up, and use the other hand to gently draw the fingers back toward you. Hold, then turn the palm down and repeat. Swap arms. Then make slow fists and spread wide, a few times.',
    },
    ...
    {
      type: 'paragraph',
      text: 'Sit tall, clasp your hands behind your back (or hold the sides of the chair), and gently draw the shoulder blades together to open the chest. Three breaths. Then interlace your fingers, turn the palms up and reach overhead to lengthen your sides for three more.',
    },
    { type: 'subheading', text: '8. Seated figure-four (optional)' },
    {
      type: 'paragraph',
      text: 'Cross your right ankle over your left knee and, sitting tall, lean forward slightly until you feel a gentle stretch in the hip. Three breaths, then switch. Hips get tight from sitting too.',
    },
    ...
    {
      type: 'cta',
      text: 'If your desk-bound team could use that, it might be worth mentioning to whoever looks after wellbeing where you work. They can also [book a pilot](/demo) to try it first. For more routines, see my longer [guide to desk yoga](/guides/desk-yoga).',
