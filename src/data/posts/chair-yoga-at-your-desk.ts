...
const post: BlogPost = {
  ...
  title: 'Chair yoga at your desk: 8 poses for office workers (no mat, no changing)',
  metaDescription:
  ...
  content: [
    {
      type: 'paragraph',
      text: "Around 80% of office workers report neck or back pain, and if you spend your day at a desk you don't need a statistic to tell you that. The good news: you can undo a surprising amount of that tension without leaving your chair, changing your clothes, or doing anything that makes you look strange to the rest of the team.",
    },
    {
      type: 'paragraph',
      text: 'Here are eight chair yoga poses you can do at your desk in about five minutes. Move gently, breathe slowly, and stop short of any sharp pain. This should feel like relief, not effort.',
    },
    { type: 'heading', text: 'Before you start' },
    {
      type: 'paragraph',
      text: 'Sit toward the front of your chair, both feet flat on the floor, and take three slow breaths, in through the nose, slower on the way out. That longer exhale is what tells your nervous system to settle. Keep it going through the whole sequence.',
    },
    ...
    {
      type: 'paragraph',
      text: 'Sit tall. Place your right hand on the outside of your left knee and gently turn to look over your left shoulder. Three breaths, then switch. Keep it gentle, the breath does more than the force.',
    },
    ...
    { type: 'subheading', text: '7. Chest opener' },
    {
      type: 'paragraph',
      text: 'Sit tall, clasp your hands behind your back (or hold the sides of the chair), and gently draw the shoulder blades together to open the chest. Three breaths. The direct antidote to the hunched-over-keyboard shape.',
    },
    { type: 'subheading', text: '8. Seated figure-four (optional)' },
    {
      type: 'paragraph',
      text: 'Cross your right ankle over your left knee and, sitting tall, lean forward slightly until you feel a gentle stretch in the hip. Three breaths, then switch. Hips get tight from sitting too, this is the fix.',
    },
    { type: 'heading', text: 'Make it a habit, not a one-off' },
    {
      type: 'paragraph',
      text: "The trick with desk stretches isn't doing them perfectly once, it's doing a little, often. Even one round between meetings adds up. Pair it with something you already do (your mid-morning coffee, the end of a call) so it doesn't rely on willpower.",
    },
