...
const post: BlogPost = {
  ...
  content: [
    ...
    { type: 'cta', text: 'Would rather not run it yourself? Start with a single pilot session, hosted for you, then once it is a weekly habit you get attendance and wellbeing reporting.', ctaHref: '/demo', ctaLabel: 'Book a pilot' },
    { type: 'faq', faqItems: [
