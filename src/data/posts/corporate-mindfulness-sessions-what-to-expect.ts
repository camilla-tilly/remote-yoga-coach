...
const post: BlogPost = {
  ...
  content: [
    ...
    { type: 'paragraph', text: 'The point is not enlightenment. It is a repeatable skill, noticing where attention is and steadying the nervous system, that people can reuse at their desks. Our [mindfulness at work guide](/guides/mindfulness-at-work) covers the evidence and the practice.' },
    ...
    { type: 'faq', faqItems: [
      ...
      { q: 'Live sessions or an app, which is better?', a: 'They do different jobs. An app is an on-demand library; a live session is the weekly habit with a real person. Live sessions out-attend apps because the hardest part, starting alone, is removed.' },
