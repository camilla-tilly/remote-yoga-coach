...
const post: BlogPost = {
  ...
  content: [
    ...
    { type: 'callout', text: 'Falling attendance tells you something useful. It does not mean the programme has failed. Look at the pattern rather than the headline number and it usually shows where the friction sits. For the underlying cause, see my [remote work burnout guide](/guides/remote-work-burnout).' },
    ...
    { type: 'paragraph', text: 'A few changes make the biggest difference. Camera optional removes the most common reason people hesitate to join a live call. A recording of every session means someone who misses the live slot can watch it later instead of missing the week. And a genuine choice of class type lets people opt into what suits them instead of quietly opting out.' },
