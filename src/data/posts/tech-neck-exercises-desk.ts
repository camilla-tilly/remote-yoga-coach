...
const post: BlogPost = {
  ...
  content: [
    { type: "paragraph", text: "If your neck feels stiff and your shoulders sit somewhere up near your ears by the afternoon, that is what people mean by tech neck. The short version: it is the forward-head, rounded-shoulder posture that builds up from looking down at screens, and the fix is gentle neck and shoulder stretches done little and often, seated, with no equipment." },
    { type: "paragraph", text: "I am a 500-hour certified yoga teacher, and this is the kind of gentle movement my live chair yoga sessions for remote teams are built on. Nothing here is fancy. It is meant to feel like relief." },
    ...
    { type: "paragraph", text: "The problem is rarely one bad moment. It is the accumulation. You settle in for a focused block of work, you stop noticing your body, and the forward-head shape becomes the default without you deciding on it. The longer you hold still, the more the front of the chest shortens and the more the back of the neck has to brace. By mid-afternoon it has quietly compounded into that familiar tight collar of tension." },
    { type: "paragraph", text: "Your setup feeds it too, so two quick checks before you stretch: get the top of your screen roughly at eye level so you are not looking down all day, and keep your shoulders relaxed with your elbows at about 90 degrees. Less tension builds in the first place." },
    { type: "heading", text: "Gentle neck and shoulder stretches for tech neck" },
    { type: "paragraph", text: "Sit tall, both feet on the floor, and take two slow breaths before you begin. Let each movement settle on a long exhale rather than forcing it. Move slowly, and stop straight away if anything feels sharp rather than releasing." },
    { type: "list", items: [
      ...
      "Cross-body shoulder stretch: bring your right arm across your chest and use your left hand to draw it gently closer, feeling the stretch across the back of the right shoulder. Three breaths, then switch. Good for shoulders tight from typing and mousing.",
    ...
    { type: "paragraph", text: "A single round helps for an hour or so, then the tension quietly rebuilds as you go back to the screen. So the real win is little and often. A short round a few times through the day does far more than one long session, because you keep resetting before the tension has a chance to set in." },
    ...
    { type: "paragraph", text: "Undoing tech neck on your own comes down to willpower, and willpower is exactly what runs low on a busy day. A short, guided session done together holds where solo stretching slips, because the time is already in the calendar. I teach chair yoga live on Teams or Zoom, the same coach each week, camera optional, and every session recorded so anyone who missed it can follow along later. If you want a version your desk-bound team keeps up, take a look at my [chair yoga for teams](/services/chair-yoga-for-teams). It runs on a flat monthly subscription in SEK." },
    ...
    { type: "faq", faqItems: [
      ...
      { q: "How often should I do these neck and shoulder stretches?", a: "Little and often works best. A gentle three-minute round a few times across the day does more than one long session, because desk tension rebuilds as soon as you return to the screen. Tie the movements to an existing habit, like the top of each hour, so you do not have to rely on remembering." },
      ...
      { q: "Does my desk setup matter, or is stretching enough?", a: "Both help. Stretching eases the tension, and your setup decides how much builds in the first place. Keep the top of your screen roughly at eye level and your shoulders relaxed with elbows at about 90 degrees. You need no equipment for the stretches, just a chair." },
    ] },
    { type: "callout", text: "Health note: this is gentle mobility, not medical advice, and I do not offer diagnosis. Keep every movement slow and comfortable, stop if anything hurts, and see a professional if neck pain is persistent or severe, or comes with anything unusual like numbness or dizziness." },
  ],
};
