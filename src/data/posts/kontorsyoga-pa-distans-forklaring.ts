...
const post: BlogPost = {
  ...
  metaDescription:
    'Vad är stolyoga eller kontorsyoga på distans egentligen, och hur går det till i praktiken via Teams? En enkel förklaring för team som är nyfikna men osäkra.',
  ...
  content: [
    ...
    { type: 'heading', text: 'Hur ett pass går till via Teams' },
    { type: 'list', items: [
      ...
      'Passet varar 15 till 30 minuter, kort nog för en lunchrast eller en lucka mellan möten.',
      'Passen kan spelas in om ni vill, så den som missar tiden kan ta det senare samma dag.',
    ] },
    ...
    { type: 'faq', faqItems: [
      ...
      { q: 'Behöver vi någon utrustning för att delta?', a: 'Nej. Allt som behövs är en dator med Teams och en vanlig kontorsstol. Ingen matta, inga träningskläder och ingen förkunskap krävs.' },
      { q: 'Hur långt är ett pass, och när på dagen passar det?', a: 'Ett pass är 15 till 30 minuter, så det ryms i en lunchrast eller mellan två möten. Passen kan spelas in om ni vill, för den som inte kan delta på den utsatta tiden.' },
