...
const post: BlogPost = {
  slug: "prevent-burnout-distributed-team",
  title: "How to prevent burnout in a distributed team",
  ...
  content: [
    ...
    {
      type: "heading",
      text: "Why distributed teams are at higher risk"
    },
    {
      type: "paragraph",
    ...
    {
      type: "heading",
      text: "The warning signs a manager can actually spot remotely"
    },
    {
      type: "paragraph",
    ...
    {
      type: "paragraph",
      text: "One of these on its own means little. A cluster of them in the same person over a few weeks is worth a private, gentle check-in, not a performance conversation."
    },
    {
      type: "heading",
    ...
    {
      type: "paragraph",
      text: "Most wellbeing budgets are spent on things that make the organisation feel like it is helping without changing the conditions that cause the problem."
    },
    {
      type: "list",
      items: [
    ...
    {
      type: "heading",
      text: "The cost framing for the budget conversation"
    },
    {
      type: "paragraph",
    ...
    {
      type: "heading",
      text: "One concrete habit to start with"
    },
    {
      type: "paragraph",
