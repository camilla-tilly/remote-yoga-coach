...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'heading', text: '1. SUP yoga och vedeldad bastu vid Sicklasjön' },
      ...
      { type: 'paragraph', text: 'Efteråt: vedeldad bastu direkt vid vattnet. Varmt, lugnt, bara ni och utsikten. Det här paketet sköts i samarbete med Smashing Balance och passar perfekt för grupper. Ingen förkunskap krävs. Mejla hello.yogawithcamilla@gmail.com för offert, eller läs mer på smashingbalance.se.' },
  ...
  },
  {
    ...
    title: '7 Hen Party Ideas in Stockholm',
    metaDescription: 'Planning a hen party in Stockholm? Here are 7 unforgettable bachelorette activities — from SUP yoga and sauna to archipelago boat trips and spa days.',
    publishDate: '2026-04-15',
    readingTime: '6 min',
    category: 'Events & Möhippa',
    excerpt: 'Stockholm is genuinely one of the best cities in the world for a hen party. Water everywhere, world-class spas, incredible food — and yes, yoga on paddleboards with a wood-fired sauna waiting on shore.',
    relatedServiceHref: '/tjanster/sup-yoga',
    ...
    content: [
      { type: 'paragraph', text: 'Stockholm is genuinely one of the best cities in the world for a hen party. Water everywhere, world-class spas, cobblestone streets in Gamla Stan, and a food scene that keeps getting better. These are seven of the best hen party ideas in Stockholm right now.' },
      { type: 'heading', text: '1. SUP yoga and wood-fired sauna at Sickla Strand' },
      { type: 'paragraph', text: 'This is the one. Yoga on paddleboards on a calm Stockholm lake, followed by a wood-fired sauna on the water\'s edge. No experience needed — the boards are wide and stable, and the whole session is taught in English. Perfect for groups up to 20.' },
      { type: 'paragraph', text: 'The SUP yoga and sauna experience is run in partnership with Smashing Balance at Sickla Strand in Nacka, just outside central Stockholm. To book a private event for your group, email hello.yogawithcamilla@gmail.com or visit smashingbalance.se/pages/privata-event-i-stockholm-sup-yoga-bastu-vid-sjon for full details.' },
      { type: 'heading', text: '2. A day at Yasuragi Japanese spa' },
      { type: 'paragraph', text: 'Yasuragi is about 20 minutes from central Stockholm and one of those places that earns every bit of its reputation. Japanese baths, wood-fired saunas, yukata robes, and meditation. They have dedicated group packages for 10 or more people.' },
      { type: 'heading', text: '3. Private archipelago boat tour' },
      ...
      { type: 'heading', text: '4. Cocktail masterclass' },
      { type: 'paragraph', text: 'A cocktail masterclass is one of the most reliably good hen party ideas because it works for every kind of group. You spend a couple of hours learning to make proper drinks, a professional bartender guides you through the techniques, and everyone has loosened up by the end.' },
      { type: 'heading', text: '5. Swedish cooking class' },
      ...
      { type: 'paragraph', text: 'Stockholm\'s Old Town is full of wine bars that run private tasting sessions for groups. A guided tasting with well-chosen wines and a cheese board is the kind of hen party activity that suits a broad age range — relaxed, sociable, easy to extend into dinner.' },
      { type: 'heading', text: '7. Outdoor adventure at Äventyrsbanan' },
      { type: 'paragraph', text: 'If your group wants to actually move and do something physical, Äventyrsbanan runs outdoor adventure packages specifically for hen parties. High ropes courses, ziplines, and outdoor challenges followed by a sauna session.' },
      { type: 'paragraph', text: 'If you want to book the SUP yoga and sauna experience for your hen party group, get in touch at hello.yogawithcamilla@gmail.com. I teach in English, the sessions are designed for all levels, and starting the morning on the water before a wood-fired sauna is a pretty hard act to follow.' },
    ]
  },
  {
    slug: 'sommaravslutning-aktiviteter-stockholm',
    title: '7 idéer för sommaravslutning i Stockholm',
    metaDescription: 'Planerar du sommaravslutning med jobbet i Stockholm? Här är 7 idéer — från SUP yoga och vedeldad bastu till skärgårdsbåt och kajakpaddling.',
    publishDate: '2026-04-15',
    readingTime: '6 min',
    category: 'Företag & Konferens',
    ...
    content: [
      ...
      { type: 'heading', text: '1. SUP yoga och vedeldad bastu vid Sickla' },
      { type: 'paragraph', text: 'Yoga på paddleboard vid Sickla är en upplevelse som ingen glömmer. Ni börjar med en guidad yogasekvens på vattnet, sen värmer ni upp i en vedeldad bastu med utsikt mot sjön. Avkopplande, roligt och lite utmanande på samma gång.' },
      { type: 'paragraph', text: 'Det krävs ingen tidigare erfarenhet. Funkar för grupper upp till 20 personer. I samarbete med Smashing Balance. Mejla hello.yogawithcamilla@gmail.com för offert, eller läs mer på smashingbalance.se.' },
      ...
      { type: 'paragraph', text: 'Vill ni boka SUP yoga och bastu för ert team? Mejla hello.yogawithcamilla@gmail.com för offert, eller läs mer på smashingbalance.se.' },
    ]
  },
  {
    ...
    readingTime: '6 min',
    category: 'Företag & Konferens',
    excerpt: 'Summer is the best time to take your team outside the office. Here are 7 team day ideas in Stockholm — from paddleboard yoga and a wood-fired sauna to archipelago boat trips.',
    relatedServiceHref: '/tjanster/sup-yoga',
    ...
    content: [
      ...
      { type: 'heading', text: '1. SUP Yoga + Wood-Fired Sauna at Sickla Strand' },
      ...
      { type: 'paragraph', text: 'After the session, you step into a wood-fired sauna right by the water. Groups of up to 20 people, instruction in English. Run in partnership with Smashing Balance. Email hello.yogawithcamilla@gmail.com or visit smashingbalance.se/pages/privata-event-i-stockholm-sup-yoga-bastu-vid-sjon.' },
      ...
      { type: 'paragraph', text: 'If you want one activity that combines movement, water, fresh air, and a proper Swedish sauna experience — the SUP yoga and sauna package at Sickla Strand is hard to beat. Email hello.yogawithcamilla@gmail.com to check availability.' },
    ]
  },
  {
    ...
    content: [
      ...
      { type: 'paragraph', text: 'Upplägget körs vid Sicklasjön i samarbete med Smashing Balance. En vedeldad bastu ingår. Funkar för grupper upp till 20 personer och kräver noll erfarenhet. Mejla hello.yogawithcamilla@gmail.com för offert, eller läs mer på smashingbalance.se.' },
      ...
      { type: 'paragraph', text: 'SUP yoga och vedeldad bastu vid Sicklasjön är vårt mest bokade teambuilding-upplägg. Mejla hello.yogawithcamilla@gmail.com för offert, eller läs mer på smashingbalance.se.' },
    ]
  },
  {
    ...
    readingTime: '6 min',
    category: 'Företag & Konferens',
    excerpt: 'Planning a team day in Stockholm? Here are 7 team building activities that actually get people talking — including paddleboard yoga with a wood-fired sauna.',
    relatedServiceHref: '/tjanster/sup-yoga',
    ...
    content: [
      ...
      { type: 'heading', text: '1. SUP Yoga + Wood-Fired Sauna at Sickla Strand' },
      { type: 'paragraph', text: 'Paddleboard yoga on Sickla Lake followed by a wood-fired sauna is genuinely one of the best team building experiences in Stockholm right now. It works for groups up to 20 people, no experience needed, and the whole thing runs in English.' },
      { type: 'paragraph', text: 'The yoga session happens on the water — your team is laughing, wobbling, and helping each other stay balanced within the first five minutes. After the session, the sauna is ready. Run in partnership with Smashing Balance. Email hello.yogawithcamilla@gmail.com or visit smashingbalance.se/pages/privata-event-i-stockholm-sup-yoga-bastu-vid-sjon.' },
      ...
      { type: 'paragraph', text: 'If you are booking team building in Stockholm and want something genuinely different, the SUP yoga and sauna at Sickla Strand is a good place to start. Email hello.yogawithcamilla@gmail.com or visit smashingbalance.se/pages/privata-event-i-stockholm-sup-yoga-bastu-vid-sjon.' },
    ]
  }
];
