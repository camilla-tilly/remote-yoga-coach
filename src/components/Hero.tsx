  ...
  return (
    ...
    >
      <div className="relative w-full min-h-[70vh] md:min-h-0 md:py-32 flex items-center">
        ...
        <p
          ref={brandRef}
          className="font-fraunces text-[3.5rem] sm:text-[4.5rem] md:text-[6rem] lg:text-[7.5rem] xl:text-[8.5rem] text-dalashala-earth mb-8 opacity-0 -translate-y-3 transition-all duration-1000 ease-out tracking-[-0.035em] leading-[0.92]"
