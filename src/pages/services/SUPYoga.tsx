  ...
  <ServicePageLayout
    ...
    faq={[
      ...
      },
      {
        ...
        answer: "Trail run i Nackareservatet (ledd av mig), tennis med Lucas, vattencyklar för alla nivåer, SUP-uthyrning för att paddla själva, och fika eller en hel måltid hos Elton's Café vid sjön. Yoga och bastu ingår alltid, vi sätter ihop det som passar gruppen utöver det."
      },
      {
