...
## Brand Voice: KAFFESTILEN (obligatorisk)
- **Stil:** Kaffestilen. Skriv som om du sitter mitt emot nagon med kaffe. Direkt, personligt, varmt.
- **Sprak:** Svenska
- **Rytm:** Kort mening. Punkt. Sen en langre. Variera. Retoriska fragor.
- **Ordval:** Vardagligt. "Grejen ar" inte "den centrala insikten". Specifikt, inte generiskt.
- **ALDRIG:** Buzzwords, corporate-jargong, em dash, prestation-fokus, "no pain no gain"
- **Kaffestilen vinner alltid pa tonalitet.** Om SEO-struktur krockar med ton, behall tonen.
